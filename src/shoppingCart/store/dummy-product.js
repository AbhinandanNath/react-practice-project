...
import emeraldBlazer from '../../assets/emerald-blazer.webp';
import scarletScarf from '../../assets/scarletScarf.webp';
...
export const DUMMY_PRODUCTS = [
  ...
  },
  {
    ...
    id: 'p7',
    image: emeraldBlazer,
    title: 'Emerald Luxe Blazer',
    price: 180,
    description:
      'Elevate your wardrobe with our Emerald Luxe Blazer. A perfect blend of bold color and sleek design, this blazer is for those who dare to stand out.',
    },
    {
    id: 'p8',
    image: scarletScarf,
    title: 'Scarlet Cashmere Scarf',
    price: 190,
    description:
      'Wrap yourself in luxury with our Scarlet Cashmere Scarf. Soft, warm, and stylish, it’s the ultimate accessory for chilly days.',
    },
];
